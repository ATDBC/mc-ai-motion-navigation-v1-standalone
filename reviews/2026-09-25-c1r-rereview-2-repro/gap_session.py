...
Mirrors ``tests/motion_nav/test_navigation_session.py::
test_gap_route_is_solved_by_the_session_coordinator`` so each repro script
starts from the same admitted JumpGap route.  Imported by the scripts in this
folder; run them from the repository root of a checkout of d1dad57 with
``PYTHONPATH=.``.
"""
