...
B01“三版参照与统一比较口径”至 B09“参数化跳跃与受控下降”已经完成。B09-R“逐 tick 运动计算器”也已完成首版支持域验收，B10 尚未开始：
...
- [B06–B15 阶段记录](docs/motion_navigation/stages/B06-B15-known-world-mobility.md)
