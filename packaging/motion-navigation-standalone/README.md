...
当前已完成 B01 至 B10、C1-A 至 C1-C，以及 C1-R 的 R0 至 R5。最新两轮工作统一了逐帧控制入口、战斗与导航会话、外力恢复和带速度的一格跨隙，并补齐了已验证动作在缺锚点、路线依赖变化和新路线交接时的身体责任。正式 Fabric 结果与适用边界写在 `docs/motion_navigation/acceptance/`。
